...
class DepartamentoController: UICollectionViewController {
    ...
    override func viewDidLoad() {
            ...
            collectionView.register(UINib(nibName: "AreaCardVentasCell", bundle: .main), forCellWithReuseIdentifier: "AreaCardVentasCell")
        ...
        override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            if departamento[indexPath.row].Nombre ==  departamento[indexPath.row].Nombre {
                cell.imagenmostrar.image = UIImage(named: "\(departamento[indexPath.row].Nombre!)")
            }else{
